...
export const PAGE_TEMPLATES = {
    ...
    ad_side_by_side: {
        ...
        blocks: (hoplink) => [
            { type: 'image', html: '<div data-media-slot="hero" style="margin:0 0 24px;border-radius:16px;overflow:hidden;background:#f5f5f5;aspect-ratio:3/4;max-width:340px;display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 8px 32px rgba(0,0,0,0.12);"><span style="color:#999;font-size:14px;">Click to add product image (600×800)</span></div>' },
            { type: 'heading', html: '<h1 style="font-size:32px;font-weight:800;color:#0f172a;line-height:1.2;margin:0 0 24px;">Your Headline Goes Here — Grab Attention Fast</h1>' },
            { type: 'list', html: '<ul style="list-style:none;padding:0;margin:0 0 28px;display:flex;flex-direction:column;gap:14px;"><li style="display:flex;align-items:flex-start;gap:10px;font-size:16px;color:#334155;line-height:1.5;"><span style="color:#22c55e;font-size:20px;flex-shrink:0;">✓</span> First key benefit or feature — what makes it unique</li><li style="display:flex;align-items:flex-start;gap:10px;font-size:16px;color:#334155;line-height:1.5;"><span style="color:#22c55e;font-size:20px;flex-shrink:0;">✓</span> Second benefit — why readers should care about this</li><li style="display:flex;align-items:flex-start;gap:10px;font-size:16px;color:#334155;line-height:1.5;"><span style="color:#22c55e;font-size:20px;flex-shrink:0;">✓</span> Third benefit — create urgency or desire here</li></ul>' },
            { type: 'button', html: `<div style="margin:0 0 24px;"><a href="${hoplink || '#'}" target="_blank" data-cta="true" style="display:inline-block;padding:18px 40px;background:linear-gradient(135deg,#2563eb,#1d4ed8);color:#fff;font-size:18px;font-weight:700;border-radius:12px;text-decoration:none;box-shadow:0 6px 20px rgba(37,99,235,0.3);transition:transform 0.2s;">Get Started Now →</a></div>` },
            { type: 'text', html: '<p style="font-size:14px;color:#64748b;line-height:1.7;margin:0;">Brief supporting text goes here. Explain the offer, social proof, or add a personal note to build trust with your reader.</p>' },
        ],
    },
};
